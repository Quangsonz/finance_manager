...
### **Personal Finance Manager | Sept 2024 - Nov 2024**

**Full-stack Developer**

Developed a comprehensive personal finance management web application using MERN stack to help users track income/expenses, manage budgets, and achieve financial goals.

**Key Responsibilities & Achievements:**
- Built RESTful API with Express.js and MongoDB, implementing JWT authentication and bcrypt password hashing
- Developed responsive React frontend with Context API for state management and real-time data visualization
- Implemented security best practices: protected routes with middleware, CORS configuration, input validation, and centralized error handling
- Created features: transaction tracking with categories, budget alerts, recurring transactions, goal tracking with progress monitoring
- Integrated data export functionality (PDF/Excel) and interactive charts using Recharts and Chart.js
- Applied MVC architecture pattern and ensured code quality with proper error handling and validation

**Technologies:** MongoDB, Express.js, React, Node.js, JWT, bcryptjs, Mongoose, Axios, TailwindCSS, Recharts

**Security Implementation:** JWT token authentication, password hashing (bcrypt - 10 salt rounds), protected API routes, input validation, CORS security, auto-logout on token expiration

---

## 📝 MÔ TẢ NGẮN GỌN (Dành cho CV 1 dòng)

```
Personal Finance Manager - Full-stack MERN application | Implemented JWT authentication, bcrypt password hashing, 
RESTful API with protected routes | Features: transaction tracking, budget management, recurring transactions, 
data visualization | Tech: MongoDB, Express, React, Node.js, JWT, TailwindCSS
```
...
```
• Developed full-stack personal finance management web app using MERN stack (MongoDB, Express, React, Node.js)
• Implemented secure JWT-based authentication with bcrypt password hashing (10 salt rounds) and protected routes
• Built RESTful API with Express middleware for authorization, input validation, and centralized error handling
• Created responsive UI using React 18, Context API, and TailwindCSS with real-time budget tracking features
• Integrated data visualization (Recharts, Chart.js) and export functionality (PDF/Excel reports)
• Applied security best practices: CORS configuration, token expiration handling, Mongoose schema validation
```

---

## 💼 MÔ TẢ CHI TIẾT (Dành cho Portfolio/Interview)

### **Project Overview**
Personal Finance Manager is a full-stack web application designed to help users manage their personal finances effectively. The application provides comprehensive tools for tracking income and expenses, setting financial goals, managing budgets, and visualizing spending patterns through interactive charts.

### **My Role**
**Full-stack Developer** - Sole developer responsible for end-to-end implementation

### **Project Goals**
- Create a secure, user-friendly platform for personal finance management
- Implement robust authentication and data protection mechanisms
- Provide real-time insights into spending habits and budget status
- Enable data-driven financial decision making through visualizations

### **Key Features Implemented**
1. **Transaction Management** - CRUD operations with filtering, searching, and categorization
2. **Budget Tracking** - Real-time budget monitoring with automated alerts at 80% and 100% thresholds
3. **Goal Setting** - Progress tracking for savings goals with priority levels and deadlines
4. **Recurring Transactions** - Automated handling of periodic income/expenses
5. **Data Visualization** - Interactive dashboards with bar charts, pie charts, and trend analysis
6. **Security** - JWT authentication, password hashing, protected routes, CORS, input validation

### **Technical Implementation**
- **Backend:** Node.js, Express.js, MongoDB, Mongoose ODM
- **Frontend:** React 18, React Router v6, Context API, Axios
- **Security:** JWT (jsonwebtoken), bcryptjs, middleware authentication
- **UI/UX:** TailwindCSS, React Icons, React Toastify, Recharts, Chart.js
- **Additional:** jsPDF, XLSX for data export, Nodemailer for email notifications

### **Achievements**
✅ Implemented defense-in-depth security with 8+ security layers  
✅ Built fully responsive UI supporting mobile, tablet, and desktop  
✅ Created reusable React components reducing code duplication by 40%  
✅ Achieved stateless API architecture enabling horizontal scalability  
✅ Integrated real-time budget alerts improving user engagement
